    ...
    <div class="d-flex justify-content-between align-items-center py-3 mb-4">
        <div>
            <h4 class="fw-bold mb-0">
                <span class="text-muted fw-light">Admin / Questions /</span> Create
            </h4>
            <p class="text-muted">Add new question for learning materials</p>
        </div>
                        ...
                        <div class="row">
                                ...
                                <select class="form-select @error('learning_material_id') is-invalid @enderror" 
                                    ...
                                    @foreach($materials as $material)
                                        <option value="{{ $material->id }}" 
                                                {{ old('learning_material_id') == $material->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <select class="form-select @error('type') is-invalid @enderror" 
                                    ...
                                    <option value="free_text" {{ old('type') === 'free_text' ? 'selected' : '' }}>
                                        Free Text
                                    </option>
                                </select>
                                @error('type')
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('points') is-invalid @enderror" 
                                       id="points" name="points" value="{{ old('points', 10) }}" required min="1">
                                @error('points')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <textarea class="form-control @error('question_text') is-invalid @enderror" 
                                  id="question_text" name="question_text" rows="6" required>{{ old('question_text') }}</textarea>
                        @error('question_text')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                                        ...
                                        <div class="col-auto">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="correct_option" 
                                                       ...
                                                       {{ old('correct_option') === $letter ? 'checked' : '' }}>
                ...
                <div class="card mb-4" id="freeTextSection" style="display: none;">
                    ...
                    <div class="card-body">
                        <textarea class="form-control @error('correct_answer') is-invalid @enderror" 
                                  ...
                                  placeholder="Enter the expected answer for this question">{{ old('correct_answer') }}</textarea>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <textarea class="form-control @error('explanation') is-invalid @enderror" 
                                  ...
                                  placeholder="Optional explanation for the answer">{{ old('explanation') }}</textarea>
                        @error('explanation')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
